...
def batch_list_in(batchlist, base_query, integration, instance, batchsize=500, dedupe=True, remove_none=True, debug=False):
    """ {"name": "batch_list_in",
         ...
         "examples": ["combined_df = batch_list_in(ip_list, ip_query, 'impala', 'hulc')"],
         "args": [{"name": "batchlist", "default": "None", "required": "True", "type": "list", "desc": "List of items to be batched and queried"},
                  ...
                  {"name": "instance", "default": "None", "required": "True", "type": "string", "desc": "The instance of the previously provided integration that will be used (i.e. hulc, thew)"},
    ...
    while next_run:
        ...
        #this_str = str(thisbatch).replace("[", "").replace("]", "")
        this_str = str(thisbatch)[1:-1]
